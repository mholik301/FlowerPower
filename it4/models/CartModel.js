...
//MODIFIKACIJA
//dodaj jedan komada nekog artikla u red
async function addItemToQueue(queue, id) {
    let itemObject = {
        id: id,
        name: undefined,
        price: undefined,
    ...
    if (queue.length > 4) queue.shift() //micemo artikl ako bi ih bilo >5 nakon dodavanja

    queue.push(itemObject) //dodajemo artikl nazad u red
}
